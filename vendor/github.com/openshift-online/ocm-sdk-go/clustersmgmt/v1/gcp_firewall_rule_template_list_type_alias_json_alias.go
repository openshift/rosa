...
// the given writer.
var MarshalGcpFirewallRuleTemplateList = api_v1.MarshalGcpFirewallRuleTemplateList

// WriteGcpFirewallRuleTemplateList writes a list of value of the 'gcp_firewall_rule_template' type to
// the given stream.
var WriteGcpFirewallRuleTemplateList = api_v1.WriteGcpFirewallRuleTemplateList

// UnmarshalGcpFirewallRuleTemplateList reads a list of values of the 'gcp_firewall_rule_template' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGcpFirewallRuleTemplateList = api_v1.UnmarshalGcpFirewallRuleTemplateList

// ReadGcpFirewallRuleTemplateList reads list of values of the ”gcp_firewall_rule_template' type from
// the given iterator.
var ReadGcpFirewallRuleTemplateList = api_v1.ReadGcpFirewallRuleTemplateList
