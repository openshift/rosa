...
// the given writer.
var MarshalGcpFirewallRuleSpecList = api_v1.MarshalGcpFirewallRuleSpecList

// WriteGcpFirewallRuleSpecList writes a list of value of the 'gcp_firewall_rule_spec' type to
// the given stream.
var WriteGcpFirewallRuleSpecList = api_v1.WriteGcpFirewallRuleSpecList

// UnmarshalGcpFirewallRuleSpecList reads a list of values of the 'gcp_firewall_rule_spec' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGcpFirewallRuleSpecList = api_v1.UnmarshalGcpFirewallRuleSpecList

// ReadGcpFirewallRuleSpecList reads list of values of the ”gcp_firewall_rule_spec' type from
// the given iterator.
var ReadGcpFirewallRuleSpecList = api_v1.ReadGcpFirewallRuleSpecList
