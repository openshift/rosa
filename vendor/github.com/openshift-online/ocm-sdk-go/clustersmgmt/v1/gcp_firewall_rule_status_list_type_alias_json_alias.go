...
// the given writer.
var MarshalGcpFirewallRuleStatusList = api_v1.MarshalGcpFirewallRuleStatusList

// WriteGcpFirewallRuleStatusList writes a list of value of the 'gcp_firewall_rule_status' type to
// the given stream.
var WriteGcpFirewallRuleStatusList = api_v1.WriteGcpFirewallRuleStatusList

// UnmarshalGcpFirewallRuleStatusList reads a list of values of the 'gcp_firewall_rule_status' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGcpFirewallRuleStatusList = api_v1.UnmarshalGcpFirewallRuleStatusList

// ReadGcpFirewallRuleStatusList reads list of values of the ”gcp_firewall_rule_status' type from
// the given iterator.
var ReadGcpFirewallRuleStatusList = api_v1.ReadGcpFirewallRuleStatusList
