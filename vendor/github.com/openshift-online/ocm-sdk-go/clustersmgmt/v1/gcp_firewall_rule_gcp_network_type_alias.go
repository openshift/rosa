...
type GcpFirewallRuleGcpNetwork = api_v1.GcpFirewallRuleGcpNetwork
...
const GcpFirewallRuleGcpNetworkListKind = api_v1.GcpFirewallRuleGcpNetworkListKind
...
const GcpFirewallRuleGcpNetworkListLinkKind = api_v1.GcpFirewallRuleGcpNetworkListLinkKind

// GcpFirewallRuleGcpNetworkNilKind is the name of the type used to nil lists of objects of
// type 'gcp_firewall_rule_gcp_network'.
const GcpFirewallRuleGcpNetworkListNilKind = api_v1.GcpFirewallRuleGcpNetworkListNilKind

type GcpFirewallRuleGcpNetworkList = api_v1.GcpFirewallRuleGcpNetworkList
