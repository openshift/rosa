...
// GcpFirewallRuleBuilder contains the data and logic needed to build 'gcp_firewall_rule' objects.
//
...
type GcpFirewallRuleBuilder = api_v1.GcpFirewallRuleBuilder

// NewGcpFirewallRule creates a new builder of 'gcp_firewall_rule' objects.
var NewGcpFirewallRule = api_v1.NewGcpFirewallRule
