...
type GcpFirewallRulesStatus = api_v1.GcpFirewallRulesStatus
...
const GcpFirewallRulesStatusListKind = api_v1.GcpFirewallRulesStatusListKind
...
const GcpFirewallRulesStatusListLinkKind = api_v1.GcpFirewallRulesStatusListLinkKind

// GcpFirewallRulesStatusNilKind is the name of the type used to nil lists of objects of
// type 'gcp_firewall_rules_status'.
const GcpFirewallRulesStatusListNilKind = api_v1.GcpFirewallRulesStatusListNilKind

type GcpFirewallRulesStatusList = api_v1.GcpFirewallRulesStatusList
