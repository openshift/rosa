...
// the given writer.
var MarshalGcpFirewallRuleGcpNetworkList = api_v1.MarshalGcpFirewallRuleGcpNetworkList

// WriteGcpFirewallRuleGcpNetworkList writes a list of value of the 'gcp_firewall_rule_gcp_network' type to
// the given stream.
var WriteGcpFirewallRuleGcpNetworkList = api_v1.WriteGcpFirewallRuleGcpNetworkList

// UnmarshalGcpFirewallRuleGcpNetworkList reads a list of values of the 'gcp_firewall_rule_gcp_network' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGcpFirewallRuleGcpNetworkList = api_v1.UnmarshalGcpFirewallRuleGcpNetworkList

// ReadGcpFirewallRuleGcpNetworkList reads list of values of the ”gcp_firewall_rule_gcp_network' type from
// the given iterator.
var ReadGcpFirewallRuleGcpNetworkList = api_v1.ReadGcpFirewallRuleGcpNetworkList
