...
type GcpFirewallRulesStatusEntry = api_v1.GcpFirewallRulesStatusEntry
...
const GcpFirewallRulesStatusEntryListKind = api_v1.GcpFirewallRulesStatusEntryListKind
...
const GcpFirewallRulesStatusEntryListLinkKind = api_v1.GcpFirewallRulesStatusEntryListLinkKind

// GcpFirewallRulesStatusEntryNilKind is the name of the type used to nil lists of objects of
// type 'gcp_firewall_rules_status_entry'.
const GcpFirewallRulesStatusEntryListNilKind = api_v1.GcpFirewallRulesStatusEntryListNilKind

type GcpFirewallRulesStatusEntryList = api_v1.GcpFirewallRulesStatusEntryList
