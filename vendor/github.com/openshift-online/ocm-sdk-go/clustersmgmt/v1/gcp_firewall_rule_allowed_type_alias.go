...
type GcpFirewallRuleAllowed = api_v1.GcpFirewallRuleAllowed
...
const GcpFirewallRuleAllowedListKind = api_v1.GcpFirewallRuleAllowedListKind
...
const GcpFirewallRuleAllowedListLinkKind = api_v1.GcpFirewallRuleAllowedListLinkKind

// GcpFirewallRuleAllowedNilKind is the name of the type used to nil lists of objects of
// type 'gcp_firewall_rule_allowed'.
const GcpFirewallRuleAllowedListNilKind = api_v1.GcpFirewallRuleAllowedListNilKind

type GcpFirewallRuleAllowedList = api_v1.GcpFirewallRuleAllowedList
