...
type GcpFirewallRuleTemplateRefListBuilder = api_v1.GcpFirewallRuleTemplateRefListBuilder

// NewGcpFirewallRuleTemplateRefList creates a new builder of 'gcp_firewall_rule_template_ref' objects.
var NewGcpFirewallRuleTemplateRefList = api_v1.NewGcpFirewallRuleTemplateRefList
