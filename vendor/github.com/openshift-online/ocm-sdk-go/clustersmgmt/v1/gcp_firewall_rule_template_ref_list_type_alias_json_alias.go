...
// the given writer.
var MarshalGcpFirewallRuleTemplateRefList = api_v1.MarshalGcpFirewallRuleTemplateRefList

// WriteGcpFirewallRuleTemplateRefList writes a list of value of the 'gcp_firewall_rule_template_ref' type to
// the given stream.
var WriteGcpFirewallRuleTemplateRefList = api_v1.WriteGcpFirewallRuleTemplateRefList

// UnmarshalGcpFirewallRuleTemplateRefList reads a list of values of the 'gcp_firewall_rule_template_ref' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGcpFirewallRuleTemplateRefList = api_v1.UnmarshalGcpFirewallRuleTemplateRefList

// ReadGcpFirewallRuleTemplateRefList reads list of values of the ”gcp_firewall_rule_template_ref' type from
// the given iterator.
var ReadGcpFirewallRuleTemplateRefList = api_v1.ReadGcpFirewallRuleTemplateRefList
