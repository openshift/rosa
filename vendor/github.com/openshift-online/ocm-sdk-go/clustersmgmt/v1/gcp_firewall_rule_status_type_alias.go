...
type GcpFirewallRuleStatus = api_v1.GcpFirewallRuleStatus

// GcpFirewallRuleStatusListKind is the name of the type used to represent list of objects of
// type 'gcp_firewall_rule_status'.
const GcpFirewallRuleStatusListKind = api_v1.GcpFirewallRuleStatusListKind
...
const GcpFirewallRuleStatusListLinkKind = api_v1.GcpFirewallRuleStatusListLinkKind

// GcpFirewallRuleStatusNilKind is the name of the type used to nil lists of objects of
// type 'gcp_firewall_rule_status'.
const GcpFirewallRuleStatusListNilKind = api_v1.GcpFirewallRuleStatusListNilKind

type GcpFirewallRuleStatusList = api_v1.GcpFirewallRuleStatusList
