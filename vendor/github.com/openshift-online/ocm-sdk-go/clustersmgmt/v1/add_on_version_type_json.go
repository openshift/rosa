...
func writeAddOnVersion(object *AddOnVersion, stream *jsoniter.Stream) {
	...
	present_ = object.bitmap_&32 != 0 && object.parameters != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&64 != 0 && object.requirements != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
	...
	present_ = object.bitmap_&256 != 0 && object.subOperators != nil
	if present_ {
		if count > 0 {
			stream.WriteMore()
		}
