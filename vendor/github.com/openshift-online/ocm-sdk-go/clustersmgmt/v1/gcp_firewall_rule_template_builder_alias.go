...
// GcpFirewallRuleTemplateBuilder contains the data and logic needed to build 'gcp_firewall_rule_template' objects.
//
...
type GcpFirewallRuleTemplateBuilder = api_v1.GcpFirewallRuleTemplateBuilder

// NewGcpFirewallRuleTemplate creates a new builder of 'gcp_firewall_rule_template' objects.
var NewGcpFirewallRuleTemplate = api_v1.NewGcpFirewallRuleTemplate
