...
type GcpFirewallRuleSpec = api_v1.GcpFirewallRuleSpec

// GcpFirewallRuleSpecListKind is the name of the type used to represent list of objects of
// type 'gcp_firewall_rule_spec'.
const GcpFirewallRuleSpecListKind = api_v1.GcpFirewallRuleSpecListKind
...
const GcpFirewallRuleSpecListLinkKind = api_v1.GcpFirewallRuleSpecListLinkKind

// GcpFirewallRuleSpecNilKind is the name of the type used to nil lists of objects of
// type 'gcp_firewall_rule_spec'.
const GcpFirewallRuleSpecListNilKind = api_v1.GcpFirewallRuleSpecListNilKind

type GcpFirewallRuleSpecList = api_v1.GcpFirewallRuleSpecList
