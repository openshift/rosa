...
// the given writer.
var MarshalGcpFirewallRuleAllowedList = api_v1.MarshalGcpFirewallRuleAllowedList

// WriteGcpFirewallRuleAllowedList writes a list of value of the 'gcp_firewall_rule_allowed' type to
// the given stream.
var WriteGcpFirewallRuleAllowedList = api_v1.WriteGcpFirewallRuleAllowedList

// UnmarshalGcpFirewallRuleAllowedList reads a list of values of the 'gcp_firewall_rule_allowed' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalGcpFirewallRuleAllowedList = api_v1.UnmarshalGcpFirewallRuleAllowedList

// ReadGcpFirewallRuleAllowedList reads list of values of the ”gcp_firewall_rule_allowed' type from
// the given iterator.
var ReadGcpFirewallRuleAllowedList = api_v1.ReadGcpFirewallRuleAllowedList
