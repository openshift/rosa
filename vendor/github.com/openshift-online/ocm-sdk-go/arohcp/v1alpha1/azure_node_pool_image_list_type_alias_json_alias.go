...
// the given writer.
var MarshalAzureNodePoolImageList = api_v1alpha1.MarshalAzureNodePoolImageList

// WriteAzureNodePoolImageList writes a list of value of the 'azure_node_pool_image' type to
// the given stream.
var WriteAzureNodePoolImageList = api_v1alpha1.WriteAzureNodePoolImageList

// UnmarshalAzureNodePoolImageList reads a list of values of the 'azure_node_pool_image' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureNodePoolImageList = api_v1alpha1.UnmarshalAzureNodePoolImageList

// ReadAzureNodePoolImageList reads list of values of the ”azure_node_pool_image' type from
// the given iterator.
var ReadAzureNodePoolImageList = api_v1alpha1.ReadAzureNodePoolImageList
