...
// the given writer.
var MarshalAzureContainerRegistryCredentialsList = api_v1alpha1.MarshalAzureContainerRegistryCredentialsList

// WriteAzureContainerRegistryCredentialsList writes a list of value of the 'azure_container_registry_credentials' type to
// the given stream.
var WriteAzureContainerRegistryCredentialsList = api_v1alpha1.WriteAzureContainerRegistryCredentialsList
...
var UnmarshalAzureContainerRegistryCredentialsList = api_v1alpha1.UnmarshalAzureContainerRegistryCredentialsList

// ReadAzureContainerRegistryCredentialsList reads list of values of the ”azure_container_registry_credentials' type from
// the given iterator.
var ReadAzureContainerRegistryCredentialsList = api_v1alpha1.ReadAzureContainerRegistryCredentialsList
