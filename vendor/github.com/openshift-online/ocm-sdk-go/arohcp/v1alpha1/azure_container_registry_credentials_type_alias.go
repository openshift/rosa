...
type AzureContainerRegistryCredentials = api_v1alpha1.AzureContainerRegistryCredentials
...
const AzureContainerRegistryCredentialsListKind = api_v1alpha1.AzureContainerRegistryCredentialsListKind
...
const AzureContainerRegistryCredentialsListLinkKind = api_v1alpha1.AzureContainerRegistryCredentialsListLinkKind

// AzureContainerRegistryCredentialsNilKind is the name of the type used to nil lists of objects of
// type 'azure_container_registry_credentials'.
const AzureContainerRegistryCredentialsListNilKind = api_v1alpha1.AzureContainerRegistryCredentialsListNilKind

type AzureContainerRegistryCredentialsList = api_v1alpha1.AzureContainerRegistryCredentialsList
