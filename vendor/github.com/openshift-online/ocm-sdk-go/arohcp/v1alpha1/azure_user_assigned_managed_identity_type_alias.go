...
type AzureUserAssignedManagedIdentity = api_v1alpha1.AzureUserAssignedManagedIdentity
...
const AzureUserAssignedManagedIdentityListKind = api_v1alpha1.AzureUserAssignedManagedIdentityListKind
...
const AzureUserAssignedManagedIdentityListLinkKind = api_v1alpha1.AzureUserAssignedManagedIdentityListLinkKind

// AzureUserAssignedManagedIdentityNilKind is the name of the type used to nil lists of objects of
// type 'azure_user_assigned_managed_identity'.
const AzureUserAssignedManagedIdentityListNilKind = api_v1alpha1.AzureUserAssignedManagedIdentityListNilKind

type AzureUserAssignedManagedIdentityList = api_v1alpha1.AzureUserAssignedManagedIdentityList
