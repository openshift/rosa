...
type AzureContainerRegistry = api_v1alpha1.AzureContainerRegistry

// AzureContainerRegistryListKind is the name of the type used to represent list of objects of
// type 'azure_container_registry'.
const AzureContainerRegistryListKind = api_v1alpha1.AzureContainerRegistryListKind
...
const AzureContainerRegistryListLinkKind = api_v1alpha1.AzureContainerRegistryListLinkKind

// AzureContainerRegistryNilKind is the name of the type used to nil lists of objects of
// type 'azure_container_registry'.
const AzureContainerRegistryListNilKind = api_v1alpha1.AzureContainerRegistryListNilKind

type AzureContainerRegistryList = api_v1alpha1.AzureContainerRegistryList
