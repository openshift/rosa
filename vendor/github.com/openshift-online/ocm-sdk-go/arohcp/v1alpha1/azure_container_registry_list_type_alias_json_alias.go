...
// the given writer.
var MarshalAzureContainerRegistryList = api_v1alpha1.MarshalAzureContainerRegistryList

// WriteAzureContainerRegistryList writes a list of value of the 'azure_container_registry' type to
// the given stream.
var WriteAzureContainerRegistryList = api_v1alpha1.WriteAzureContainerRegistryList

// UnmarshalAzureContainerRegistryList reads a list of values of the 'azure_container_registry' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalAzureContainerRegistryList = api_v1alpha1.UnmarshalAzureContainerRegistryList

// ReadAzureContainerRegistryList reads list of values of the ”azure_container_registry' type from
// the given iterator.
var ReadAzureContainerRegistryList = api_v1alpha1.ReadAzureContainerRegistryList
