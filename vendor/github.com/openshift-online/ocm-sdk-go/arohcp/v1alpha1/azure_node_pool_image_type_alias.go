...
type AzureNodePoolImage = api_v1alpha1.AzureNodePoolImage

// AzureNodePoolImageListKind is the name of the type used to represent list of objects of
// type 'azure_node_pool_image'.
const AzureNodePoolImageListKind = api_v1alpha1.AzureNodePoolImageListKind
...
const AzureNodePoolImageListLinkKind = api_v1alpha1.AzureNodePoolImageListLinkKind

// AzureNodePoolImageNilKind is the name of the type used to nil lists of objects of
// type 'azure_node_pool_image'.
const AzureNodePoolImageListNilKind = api_v1alpha1.AzureNodePoolImageListNilKind

type AzureNodePoolImageList = api_v1alpha1.AzureNodePoolImageList
