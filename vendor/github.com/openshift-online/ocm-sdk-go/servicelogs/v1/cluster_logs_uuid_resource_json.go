...
func readClusterLogsUUIDListRequest(request *ClusterLogsUUIDListServerRequest, r *http.Request) error {
	var err error
	query := r.URL.Query()
...
func writeClusterLogsUUIDListResponse(response *ClusterLogsUUIDListServerResponse, w http.ResponseWriter) error {
