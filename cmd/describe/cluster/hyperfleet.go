...
func runHyperfleetDescribe(r *rosa.Runtime, cmd *cobra.Command, argv []string) {
	...
	if output.HasFlag() {
		m := hfClusterToMap(cluster, dataPlaneAZs, npList)
...
func hfClusterToMap(c *v1alpha1.Cluster, dataPlaneAZs map[string]struct{}, npList *v1alpha1.NodePoolList) map[string]interface{} {
