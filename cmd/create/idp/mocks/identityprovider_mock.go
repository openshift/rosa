...
//
//	mockgen-v0.4.0 --build_flags=--mod=mod -package mocks -destination=cmd/create/idp/mocks/identityprovider_mock.go -source=cmd/create/idp/cmd.go IdentityProvider
//
