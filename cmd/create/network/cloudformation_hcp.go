...
// This file is used for binary builds - HCP template with Route53 hosted zone
//
//nolint:lll
const CloudFormationHCPTemplateFile = `
AWSTemplateFormatVersion: '2010-09-09'
Description: CloudFormation template to create a ROSA HCP VPC with private hosted zone.
  This template creates a VPC with public/private subnets, NAT gateways, VPC endpoints,
  and a Route53 private hosted zone for HCP cluster internal DNS.
