...
// Source: pkg/kubeletconfig/config.go
//
// Generated by this command:
//
//	mockgen-v0.4.0 -source=pkg/kubeletconfig/config.go -package=kubeletconfig -destination=pkg/kubeletconfig/capability_checker_mock.go
//
