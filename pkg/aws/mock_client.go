...
//
//	mockgen-v0.4.0 -source=pkg/aws/client.go -package=aws -destination=pkg/aws/mock_client.go
//
...
func (m *MockClient) FilterVPCsPrivateSubnets(isHostedCp bool, subnets []types.Subnet) ([]types.Subnet, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) FilterVPCsPrivateSubnets(isHostedCp, subnets any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockClient) GetVPCPrivateSubnets(isHostedCp bool, subnetID string) ([]types.Subnet, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) GetVPCPrivateSubnets(isHostedCp, subnetID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
