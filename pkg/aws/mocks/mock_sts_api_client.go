...
// Source: pkg/aws/sts_api_client.go
...
func (mr *MockStsApiClientMockRecorder) AssumeRole(ctx, params interface{}, optFns ...interface{}) *gomock.Call {
...
func (mr *MockStsApiClientMockRecorder) AssumeRoleWithWebIdentity(ctx, params interface{}, optFns ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, params}, optFns...)
...
func (mr *MockStsApiClientMockRecorder) GetCallerIdentity(ctx, params interface{}, optFns ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, params}, optFns...)
