...
// Source: pkg/machinepool/machinepool.go
//
// Generated by this command:
//
//	mockgen-v0.4.0 -source=pkg/machinepool/machinepool.go -package=machinepool -destination=pkg/machinepool/machinepool_mock.go
//
