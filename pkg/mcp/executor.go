...
// executeWithCapture executes a command function and captures its output
// This is an alternative approach that executes the command function directly
func executeWithCapture(cmd *cobra.Command, args []string, runFunc func(*cobra.Command, []string)) (string, string, error) {
