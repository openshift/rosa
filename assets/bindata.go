...
var _bintree = &bintree{nil, map[string]*bintree{
	"templates": {nil, map[string]*bintree{
		...
		"policies": {nil, map[string]*bintree{
			"openshift_cloud_credential_operator_cloud_credential_operator_iam_ro_creds_policy.json": {templatesPoliciesOpenshift_cloud_credential_operator_cloud_credential_operator_iam_ro_creds_policyJson, map[string]*bintree{}},
			"openshift_cloud_network_config_controller_cloud_credentials_policy.json":                {templatesPoliciesOpenshift_cloud_network_config_controller_cloud_credentials_policyJson, map[string]*bintree{}},
			"openshift_cluster_csi_drivers_ebs_cloud_credentials_policy.json":                        {templatesPoliciesOpenshift_cluster_csi_drivers_ebs_cloud_credentials_policyJson, map[string]*bintree{}},
			"openshift_image_registry_installer_cloud_credentials_policy.json":                       {templatesPoliciesOpenshift_image_registry_installer_cloud_credentials_policyJson, map[string]*bintree{}},
			"openshift_ingress_operator_cloud_credentials_policy.json":                               {templatesPoliciesOpenshift_ingress_operator_cloud_credentials_policyJson, map[string]*bintree{}},
			"openshift_machine_api_aws_cloud_credentials_policy.json":                                {templatesPoliciesOpenshift_machine_api_aws_cloud_credentials_policyJson, map[string]*bintree{}},
			"operator_iam_role_policy.json":                                                          {templatesPoliciesOperator_iam_role_policyJson, map[string]*bintree{}},
			"osd_scp_policy.json":                                                                    {templatesPoliciesOsd_scp_policyJson, map[string]*bintree{}},
			"sts_installer_permission_policy.json":                                                   {templatesPoliciesSts_installer_permission_policyJson, map[string]*bintree{}},
			"sts_installer_trust_policy.json":                                                        {templatesPoliciesSts_installer_trust_policyJson, map[string]*bintree{}},
			"sts_instance_controlplane_permission_policy.json":                                       {templatesPoliciesSts_instance_controlplane_permission_policyJson, map[string]*bintree{}},
			"sts_instance_controlplane_trust_policy.json":                                            {templatesPoliciesSts_instance_controlplane_trust_policyJson, map[string]*bintree{}},
			"sts_instance_worker_permission_policy.json":                                             {templatesPoliciesSts_instance_worker_permission_policyJson, map[string]*bintree{}},
			"sts_instance_worker_trust_policy.json":                                                  {templatesPoliciesSts_instance_worker_trust_policyJson, map[string]*bintree{}},
			"sts_ocm_admin_permission_policy.json":                                                   {templatesPoliciesSts_ocm_admin_permission_policyJson, map[string]*bintree{}},
			"sts_ocm_permission_policy.json":                                                         {templatesPoliciesSts_ocm_permission_policyJson, map[string]*bintree{}},
			"sts_ocm_trust_policy.json":                                                              {templatesPoliciesSts_ocm_trust_policyJson, map[string]*bintree{}},
			"sts_ocm_user_trust_policy.json":                                                         {templatesPoliciesSts_ocm_user_trust_policyJson, map[string]*bintree{}},
			"sts_support_permission_policy.json":                                                     {templatesPoliciesSts_support_permission_policyJson, map[string]*bintree{}},
			"sts_support_trust_policy.json":                                                          {templatesPoliciesSts_support_trust_policyJson, map[string]*bintree{}},
		}},
	}},
}}
