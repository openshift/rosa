...
const defaultNodePoolReplicas = "2"

var _ = Describe("HCP Machine Pool",
	...
	func() {
		...
		Describe("can create", func() {
			It("and edit/list/delete nodepool - [id:56782]",
			...
			It("with defined subnets - [id:60202]",
				labels.Critical, labels.Runtime.Day2,
				func() {
					var subnets []string
			...
			It("with tuning config(s) - [id:63178]",
				labels.Critical, labels.Runtime.Day2,
				func() {
			...
			It("with additional security group IDs [id:72195]", labels.Critical, labels.Runtime.Day2, func() {
			...
			It("with 'version' parameter - [id:61138]",
			...
			It("with maxunavailable/maxsurge - [id:74387]",
				labels.Critical, labels.Runtime.Day2,
				func() {
			...
			It("with node_drain_grace_period - [id:72715]",
				labels.High, labels.Runtime.Day2,
				func() {
		...
		Describe("can scale up/down", func() {
			DescribeTable("with autoscaling disabled", labels.Critical, labels.Runtime.Day2,
				func(instanceType string, amdOrArm string) {
					if !isMultiArch && amdOrArm == constants.ARM {
						SkipNotMultiArch()
					}

					By("Create machinepool with " + amdOrArm + " instance " + instanceType) //nolint:goconst
			...
			It("with autoscaling enabled - [id:60278]", labels.Medium, labels.Runtime.Day2, func() {
		...
		Describe("can validate", func() {
			...
			It("creation with tuning config - [id:63179]",
			...
			It("the version parameter - [id:61139]",
				labels.Medium, labels.Runtime.Day2,
				func() {
			...
			It("scale up/down with autoscaling enabled - [id:60278]", labels.Critical, labels.Runtime.Day2, func() {
				instanceType := constants.M52XLarge
				By("Create machinepool with" + " instance " + instanceType + " and enable autoscale")
				...
				expectErrMsg = "invalid syntax" //nolint:goconst
				Expect(err).To(HaveOccurred())
				Expect(err.Error()).Should(ContainSubstring(expectErrMsg))
			})

			DescribeTable("scale up/down with autoscaling disabled", labels.Critical, labels.Runtime.Day2,
			...
			It("AWS preflight tag validation - [id:73638]",
				labels.Medium, labels.Runtime.Day2,
				func() {
					...
					for i := 0; i < maxTags+1; i++ {
						t := strconv.Itoa(i)
						key := "foo" + t
						kvp := key + ":testValue" //nolint:goconst
			...
			It("maxunavailable/maxsurge parameters - [id:74430]",
				labels.Medium, labels.Runtime.Day2,
				func() {
		...
		Describe("upgrades", func() {
			It("can be listed/described/deleted - [id:67414]",
				labels.Critical, labels.Runtime.Day2,
				func() {
			...
			It("can be realized - [id:67412]", labels.Critical, labels.Runtime.Upgrade,
				func() {
